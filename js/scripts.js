(function ($) {
	...
	function updateTotal() {
		const delivery1 = document.getElementById('deliveryChek1').previousElementSibling.checked;
		const delivery2 = document.getElementById('deliveryChek2').previousElementSibling.checked;
		const delivery3 = document.getElementById('deliveryChek3').previousElementSibling.checked;
	...
	const clickDelivery1 = document.getElementById('delivery1');
	const clickDelivery2 = document.getElementById('delivery2');
	const clickDelivery3 = document.getElementById('delivery3'); +


		clickDelivery1.addEventListener("click", () => {
			updateTotal();
		});

	clickDelivery2.addEventListener("click", () => {
		updateTotal();
	});

	clickDelivery3.addEventListener("click", () => {
		updateTotal();
	});
